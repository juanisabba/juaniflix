      ...
      <div>
        ...
        <div className="responsive-navbar">
          ...
          />
            ...
            <Link className="link homepage-list" to="/juaniflix">
              Home
            </Link>
          </li>
          <li onClick={handleClick}>
            <Link className="link tv-shows-list" to="/juaniflix/tv-shows">
              TV Shows
            </Link>
          </li>
          <li onClick={handleClick}>
            <Link className="link movies-list" to="/juaniflix/movies">
              Movies
            </Link>
          </li>
          <li onClick={handleClick}>
            <Link className="link trending-list" to="/juaniflix/trending">
              New & Popular
            </Link>
          </li>
            </ul>
